...
var LAMPS = [
  { n: 'Check Engine (двигун)', c: 'жовтий', s: 'service',
  ...
  { n: 'Тиск масла (маслянка)', c: 'червоний', s: 'stop',
  ...
  { n: 'Акумулятор (зарядка)', c: 'червоний', s: 'service',
  ...
  { n: 'Температура двигуна', c: 'червоний', s: 'stop',
  ...
  { n: 'Гальмівна система', c: 'червоний', s: 'stop',
  ...
  { n: 'Подушки безпеки (SRS)', c: 'червоний', s: 'service',
  ...
  { n: 'Тиск у шинах', c: 'жовтий', s: 'watch',
  ...
  { n: 'ESP / антипробуксовка', c: 'жовтий', s: 'watch',
  ...
  { n: 'Свічки розжарювання (спіраль)', c: 'жовтий', s: 'service',
  ...
  { n: 'Сажовий фільтр (DPF)', c: 'жовтий', s: 'service',
  ...
  { n: 'Низький рівень пального', c: 'жовтий', s: 'info',
...
var DO = {
  ...
  lampPick: function (t) {
    ...
    lampShow({ known: true, name: x.n, color: x.c, severity: x.s,
